...
export default class SwarmFM extends AudioBase {
    ...
    private async CheckSync() {
        ...
        else if (!window.isMobile && latency > SwarmFM.TARGET_LATENCY * 1.1) {
            const give = 16
