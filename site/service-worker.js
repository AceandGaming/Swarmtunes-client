...
const staticFiles = ['index.html', 'src/main-e69cc7b6.js', 'src/styles-5972e7eb.css', 'src/assets/neuro-cry.png', 'src/assets/evil-bg.png', 'src/assets/evil-cheer.webp', 'src/assets/no-song.png', 'src/assets/neuro-cheer.webp', 'src/assets/icons/disc.svg', 'src/assets/icons/playlist.svg', 'src/assets/icons/shuffle.svg', 'src/assets/icons/volume-off.svg', 'src/assets/icons/newero.avif', 'src/assets/icons/note.png', 'src/assets/icons/play-img.svg', 'src/assets/icons/folder-plus.svg', 'src/assets/icons/layout-grid.svg', 'src/assets/icons/plus.svg', 'src/assets/icons/track-prev.svg', 'src/assets/icons/share.svg', 'src/assets/icons/newliv.avif', 'src/assets/icons/maximize.svg', 'src/assets/icons/x.svg', 'src/assets/icons/tool.svg', 'src/assets/icons/search.svg', 'src/assets/icons/web.svg', 'src/assets/icons/play.svg', 'src/assets/icons/volume.svg', 'src/assets/icons/file-export.svg', 'src/assets/icons/swarmfm.png', 'src/assets/icons/track-next.svg', 'src/assets/icons/trash.svg', 'src/assets/icons/edit.svg', 'src/assets/icons/volume-2.svg', 'src/assets/icons/pause.svg', 'src/assets/icons/x-img.svg', 'src/assets/icons/playlist-remove.svg', 'src/assets/icons/playlist-add.svg', 'src/assets/icons/moon.svg', 'src/assets/neuro-bg.png']
